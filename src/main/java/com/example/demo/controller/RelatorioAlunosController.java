...
public class RelatorioAlunosController {
	...
	public ResponseEntity<RelatorioAlunos> addAcessoPorMatricula(@RequestBody RelatorioAlunos relatorioAlunos){
		relatorioAlunos.setNomeCompleto(relatorioAlunos.getNomeCompleto());
		relatorioAlunos.setCpf(relatorioAlunos.getCpf());
		relatorioAlunos.setMatricula(relatorioAlunos.getMatricula());
